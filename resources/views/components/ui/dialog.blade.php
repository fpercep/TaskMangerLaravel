    ...
    <template x-teleport="body">
        <div x-show="show" 
            ...
            <div x-show="show" 
                 ...
                 class="relative bg-white rounded-dropdown shadow-modal border border-gray-100 w-full {{ $maxWidthClasses }} {{ $alignmentClass }} transform transition-all overflow-hidden z-10">
