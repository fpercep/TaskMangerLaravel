<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="text-sm text-gray-600 hover:text-black hover:underline rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900" href="{{ route('login') }}">
